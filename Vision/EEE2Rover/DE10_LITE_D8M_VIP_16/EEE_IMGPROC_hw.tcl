...
add_interface_port avalon_master avalon_spi_addr address Output 5
add_interface_port avalon_master avalon_master_write write_n Output 1
add_interface_port avalon_master avalon_from_SPI readdata Input 16
add_interface_port avalon_master avalon_to_SPI writedata Output 16
add_interface_port avalon_master avalon_master_read read_n Output 1
add_interface_port avalon_master avalon_spi_select chipselect Output 1
