  ...
  return (
    <header className="site-header sticky-top py-3 bg-dark">
      <nav className="container d-flex flex-column flex-md-row justify-content-around">
        ...
        <Link className="py-2 d-none d-md-inline-block nav-link" to="/autopilot"> AutoPilot </Link>
        <Link className="py-2 d-none d-md-inline-block nav-link" to="/touristmode"> TouristMode </Link>
