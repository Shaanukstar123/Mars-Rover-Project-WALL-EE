...
const About = () => {
  return (
    <main>
      <div className="position-relative overflow-hidden p-5 p-md-3 m-md-3 text-center bg-light rounded-2">
        <div className="col-md-5 p-lg-5 mx-auto my-5 rounded-pill">
      ...
      <div className="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
        ...
        <div className="bg-danger me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
          <div className="my-3 py-3">
